...
<script>
import {listStudent, getStudent, delStudent, addStudent, updateStudent, exportStudent, changeStudentStatus} from "@/api/core/student";
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.studentName + '"用户吗？').then(function() {
